...
global.wm = `Copyright © 2024 KaaKangSatir` // footer text
...
global.idsal = "error@newsletter" // Opsional
global.botname = 'Shun Ai' // Ini nama bot
global.bottz = '6281226680862' // Ganti dengan nomor bot untuk mendapatkan code pairing 
global.packname = 'Shun Ai' // wm sticker
global.author = `Date: ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}\nCreator: www.kaakangsatir.my.id \nBot: 0812-2668-0862` // wm sticker
global.prefa = ['','!','.',',','🐤','🗿']
...
//—————「 OWNER 」—————//
global.ownername = 'nop' // Ubah jadi nama lu
global.owner = ['6285609279108'] // Ubah pake nomor lu
global.ownermail = ['namabelakang356@gmail.com'] // Opsional
//—————「 OWNER 」—————//
